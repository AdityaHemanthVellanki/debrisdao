...
const Footer = () => {
  return (
    <footer className="bg-space-navy border-t border-neon-cyan/20 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            <Link href="/" className="flex items-center">
              <span className="text-neon-cyan text-2xl font-bold mr-2">∞</span>
              <span className="font-orbitron text-neon-cyan text-lg font-bold">DebrisDAO</span>
            </Link>
        ...
        <div className="mt-8 border-t border-gray-800 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-xs">© 2025 DebrisDAO — Prototype</p>
          <div className="flex space-x-4 mt-4 md:mt-0">
            <Link href="#" className="text-gray-400 hover:text-neon-cyan">
